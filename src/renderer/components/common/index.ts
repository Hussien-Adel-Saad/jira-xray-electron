...
import { registerAuthHandlers, clearSession, initializeAuth } from '../../../main/ipc/authHandlers';
import { registerTestHandlers } from '../../../main/ipc/testHandlers';
import { registerTemplateHandlers } from '../../../main/ipc/templateHandlers';
...
function registerHandlers() {
  ...
  // Open external URL in default system browser (for "Open in Jira" buttons)
